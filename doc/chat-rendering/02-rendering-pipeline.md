...
- streaming 文本揭示速率由 `RenderConstants.streamingPresentationPolicy` 统一控制；生产默认按 backlog 连续调速，范围约 `20...40 chars/s`
- terminal completion 默认不再用固定 `250ms` 强制全显，完成态也遵守该 presentation policy
